...
contract('ColdChain', (accounts) => {
  ...
  it('should add entities succesfully', async () => {
    for(const entity in this.defaultEntities) {
      ...
      //console.log("Retrieved Entity:", retrievedEntity.id);
  ...
  it('should add vaccine batches succesfully', async () => {
  ...
  it('should sign and store as a certificate from the issuer to the prover', async() => {
    const mnemonic = "rebuild fiber lab engage fury mimic earth awesome bachelor insect icon base";
